...
// Validaciones basicas
	...
	if (!is_numeric($_POST['tel'])){js_redireccion("error.php?msn=N&uacute;mero de Tel&eacute;fono Inv&aacute;lido");exit;}
	if ($_POST['cont'] == '0'){js_redireccion("error.php?msn=Debe seleccionar un N&uacute;mero de Contrato");exit;}
	if ($_POST['Cate'] == 0){js_redireccion("error.php?msn=Debe seleccionar un tipo de Acreditaci&oacuet;n");exit;}
...
// validacion de existencia	
		...
		if (mysql_num_rows($result) != 0){js_redireccion("error.php?msn=La C&uacute;dula N&uacute;mero: ".$ced.", ya est&aacute; registrada");exit;}	
	//exit;
