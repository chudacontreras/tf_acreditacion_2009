...
//echo "rif de la empresa"." ".$rif." "."Nombre de la empresa".$emp;
...
echo "rif".$fila['rif']." "." "."Nombre"." ".$fila['nombre'];
						echo "<tr>";
...
Desarrollado por la Direcci&oacute;n de Informatica (Unidad de Dise&ntilde;o y Desarro</font></td>
  </tr>
  <tr>
    <td height="3" colspan="2" bgcolor="#000000"><img src="images/spacer.gif" width="1" height="3"></td>
  </tr>
